...
object MeshMetrics {
  ...
  /**
    * For each point of the first tetrhedral mesh, this method computes the shortest distance to the tetrahedron points of the
    * second tetrahedral mesh and returns the average over all points
    */
  ...
  /**
    * Returns the average mesh distance after performing a rigid alignment between the two tetrahedral meshes.
    * All tetrahedral mesh points are used for the rigid alignment, therefore both meshes must be in correspondence
    */
  ...
  /**
    * Returns the Hausdorff distance between the two tetrahedral meshes
    */
  ...
  /**
    * Computes a distance image for each mesh and returns the Dice Coefficient between the two images
    */
  def diceCoefficient(m1: TetrahedralMesh[_3D], m2: TetrahedralMesh[_3D])(implicit rand: Random): Double = {
    val imgA = m1.operations.toDistanceImage
    val imgB = m2.operations.toDistanceImage
